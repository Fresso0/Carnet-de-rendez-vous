...
fenetrecarnet::fenetrecarnet(QWidget *parent)
    : QMainWindow(parent)
{
    creeInterface();
...
fenetrecarnet::~fenetrecarnet() {}

void fenetrecarnet::creeInterface()
{
    ...
    connect(ajouterAction, &QAction::triggered, this, &fenetrecarnet::afficherPageAjouter);
    connect(ajouterRdv, &QAction::triggered, this, &fenetrecarnet::afficherPageAjouterRDV);
    connect(exporterParticipant, &QAction::triggered, this, &fenetrecarnet::afficherPageExporterParticipant);
    connect(importerParticipant, &QAction::triggered, this, &fenetrecarnet::afficherPageImporterParticipant);
    connect(exporterRDV, &QAction::triggered, this, &fenetrecarnet::afficherPageExporterRDV);
    connect(importerRDV, &QAction::triggered, this, &fenetrecarnet::afficherPageImporterRDV);
    connect(afficherRdvP, &QAction::triggered, this, &fenetrecarnet::afficherPageAfficherTousRDVsPersonne);
    connect(afficherDate, &QAction::triggered, this, &fenetrecarnet::afficherPageAfficherDate);
    connect(RechercherPRdv, &QAction::triggered, this, &fenetrecarnet::afficherPageAfficherRechercherPRdv);
    connect(ParticipantRdv, &QAction::triggered, this, &fenetrecarnet::afficherPageAfficherPRdv);
    ...
    connect(btnP , &QPushButton::clicked, this, &fenetrecarnet::afficherPersonnes);
    connect(btnRdv , &QPushButton::clicked, this, &fenetrecarnet::afficherRDVs);
    connect( btnEx, &QPushButton::clicked, this, &fenetrecarnet::exporterCarnet);
    connect( btnQ, &QPushButton::clicked, this, &fenetrecarnet::quitter);
...
void fenetrecarnet::afficherPageAjouter()
{
    ...
    connect(ajouterParticipantButtonA , &QPushButton::clicked, this, &fenetrecarnet::ajouterPersonne);
}

void fenetrecarnet::afficherPageAjouterRDV()
{
    ...
    QCalendarWidget QTableView::item {
        ...
        connect(ajouterRDVButtonAR, &QPushButton::clicked, this, &fenetrecarnet::ajouterRDV);
}
void fenetrecarnet::afficherPageExporterParticipant()
{
    ...
    connect(exporterPButton, &QPushButton::clicked, this, &fenetrecarnet::exporterParticipant);

}

void fenetrecarnet::afficherPageImporterParticipant() {
    ...
    connect(importerPButton, &QPushButton::clicked, this, &fenetrecarnet::importerParticipant);
}

void fenetrecarnet::afficherPageExporterRDV() {
    ...
    connect(exporterRButton, &QPushButton::clicked, this, &fenetrecarnet::exporterRDV);
}


void fenetrecarnet::afficherPageImporterRDV() {
    ...
    connect(importerRButton, &QPushButton::clicked, this, &fenetrecarnet::importerRDV);
}

void fenetrecarnet::afficherPageAfficherTousRDVsPersonne() {
    ...
    connect(afficherTousRDVsPersonne, &QPushButton::clicked, this, &fenetrecarnet::afficherRDVsDUnParticipant);
}

void fenetrecarnet::afficherPageAfficherDate() {
    ...
    connect(afficherRDVDateButton, &QPushButton::clicked, this, &fenetrecarnet::afficherRDVsDate);
...
void fenetrecarnet::afficherPageAfficherRechercherPRdv() {
    ...
    connect(rehcercherRDVPButtonRR, &QPushButton::clicked, this, &fenetrecarnet::rechercher);
}


void fenetrecarnet::afficherPageAfficherPRdv() {
    ...
    connect(afficherParticipantsRDVButton, &QPushButton::clicked, this, &fenetrecarnet::afficherParticipantsDUnRDV);
}




void fenetrecarnet::demarrer()
{
...
void fenetrecarnet::ajouterPersonne() {
...
void fenetrecarnet::modifierPersonne(participant p, QDialog* fenetreListe) {
...
void fenetrecarnet::supprimerPersonne(participant p, QDialog* fenetreListe){
...
void fenetrecarnet::afficherPersonnes() {
...
void fenetrecarnet::modifierRDV(RDV r, QDialog* fenetreListe)
{
...
/**void fenetrecarnet::supprimerRDV(RDV r,QDialog* fenetreListe)
{
...
void fenetrecarnet::afficherRDVs() {
    // Créez une instance de la nouvelle fenêtre pour afficher la liste
    QDialog* fenetreListe = new QDialog(this);
...
void fenetrecarnet::ajouterParticipantAUnRDV(participant p, QDialog* fenetreListe)
{
...
void fenetrecarnet::afficherRDVsDUnParticipant()
{
...
void fenetrecarnet::appliquerStyleBoutons()
{
...
void fenetrecarnet::afficherRDVsDate()
{
...
void fenetrecarnet::afficherParticipantsDUnRDV()
{
...
void fenetrecarnet::on_calendarWidget_selectionChanged()
{
...
void fenetrecarnet::exporterParticipant()
{
...
void fenetrecarnet::importerParticipant()
{
...
void fenetrecarnet::exporterRDV()
{
...
void fenetrecarnet::exporterCarnet()
{
...
void fenetrecarnet::importerRDV()
{
...
void fenetrecarnet::retirer(participant p, QDialog* fenetreListe)
{
...
/*
void fenetrecarnet::retirer(participant p, QDialog* fenetreListe) {
    // Demander le nom du rendez-vous dont on veut retirer le participant
    QString nomrdv = QInputDialog::getText(this, "Retirer du rendez-vous",
                                           "Entrez le nom du rendez-vous:", QLineEdit::Normal,
                                           "", nullptr);

    // Vérifier si le nom du rendez-vous est vide
    if (nomrdv.isEmpty()) {
        QMessageBox::warning(this, "Attention", "Le nom du rendez-vous ne peut pas être vide.");
        return;
    }
    ...
    RDV rr;
    // Chercher le rendez-vous dans la liste des rendez-vous
    if (!listeRDV.chercheParNom(nomrdv.toStdString(), rr)) {
        QMessageBox::critical(this, "Erreur", "Le rendez-vous n'existe pas.");
        return;
    }

    // Trouver le participant dans la liste des personnes
    participant pp;
    if (!listeP.trouverParticipant(p.retourneNom(), p.retournePrenom(), pp)) {
        QMessageBox::critical(this, "Erreur", "Le participant n'existe pas.");
        return;
    }

    // Vérifier si le participant est bien associé au rendez-vous
    if (!listeRDV.estAssocieeAuRDV(pp, rr)) {
        QMessageBox::critical(this, "Erreur", "Le participant n'est pas associé à ce rendez-vous.");
        return;
    }

    // Retirer le participant du rendez-vous dans la liste des rendez-vous
    listeRDV.retirerParticipantRdv(nomrdv.toStdString(), p);

    // Retirer le rendez-vous du participant dans la liste des participants
    listeP.supprimerRDVP(p.retourneNom(), p.retournePrenom(), rr);

    // Afficher un message de succès
    QMessageBox::information(this, "Opération réussie", "Le participant a été retiré du rendez-vous avec succès.");
